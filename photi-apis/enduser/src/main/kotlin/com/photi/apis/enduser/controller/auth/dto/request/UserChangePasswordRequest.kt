...
import com.photi.core.domain.user.dto.UserServiceChangePasswordDto
...
data class UserChangePasswordRequest(
    ...
    fun toServiceDto() = UserServiceChangePasswordDto(password, newPassword, newPasswordReEnter)
}
