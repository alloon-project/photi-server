...
import com.photi.server.service.user.dto.ContactServiceSendVerificationDto
...
data class ContactSendVerificationRequest(
    ...
    fun toServiceDto(): ContactServiceSendVerificationDto {
        return ContactServiceSendVerificationDto(email)
    }
}
