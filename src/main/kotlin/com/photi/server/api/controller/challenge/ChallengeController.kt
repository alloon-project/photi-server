package com.photi.server.api.controller.challenge

import com.photi.server.api.controller.challenge.request.*
...
import com.photi.server.common.response.CollectionSuccessResponse
import com.photi.server.common.response.SliceResponse
...
class ChallengeController(
    ...
    @ApiErrorResponses([EMPTY_FILE_INVALID, TOKEN_UNAUTHENTICATED, TOKEN_UNAUTHORIZED, USER_NOT_FOUND, FILE_SIZE_EXCEED, IMAGE_TYPE_UNSUPPORTED, CHALLENGE_LIMIT_EXCEED])
    fun createChallenge(
        principal: Principal,
