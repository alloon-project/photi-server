...
import com.photi.server.common.constant.RegexPatternConstants.Companion.LETTER_NUMBER_SPECIAL_CHARACTER
import com.photi.server.service.user.dto.UserServiceChangePasswordDto
...
data class UserChangePasswordRequest(
    ...
    @field:Pattern(regexp = LETTER_NUMBER_SPECIAL_CHARACTER, message = "비밀번호는 영어, 숫자, 특수문자의 조합으로 입력해 주세요.")
