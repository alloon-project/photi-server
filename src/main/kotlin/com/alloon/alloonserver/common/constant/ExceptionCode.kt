...
enum class ExceptionCode(
    ...
    MISSION_GOAL_FIELD_REQUIRED(BAD_REQUEST, "목표는 필수 입력입니다."),
    ...
    HASHTAGS_FIELD_REQUIRED(BAD_REQUEST, "해시태그는 필수 입력입니다."),
    ...
    MISSION_DESCRIPTION_LENGTH_INVALID(BAD_REQUEST, "미션 소개는 10~120자만 가능합니다."),
    MISSION_RULES_LENGTH_INVALID(BAD_REQUEST, "규칙은 0~5개만 가능합니다."),
    MISSION_RULE_LENGTH_INVALID(BAD_REQUEST, "규칙은 1~30자만 가능합니다."),
    MISSION_GOAL_LENGTH_INVALID(BAD_REQUEST, "목표는 1~30자만 가능합니다."),
    MISSION_IMAGE_URL_LENGTH_INVALID(BAD_REQUEST, "미션 대표 이미지는 1~500자만 가능합니다."),
    HASHTAGS_LENGTH_INVALID(BAD_REQUEST, "해시태그는 1~5개만 가능합니다."),
