...
(
    contact_id	        BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE users
(
    user_id               BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    ...
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    contact_id            BIGINT UNSIGEND           NOT NULL,
    CONSTRAINT fk_user_contact FOREIGN KEY (contact_id) REFERENCES contact (contact_id)
);

CREATE TABLE user_role
(
    user_role_id          BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    role                  VARCHAR(6)                NOT NULL,
    user_id               BIGINT UNSIGEND           NOT NULL,
    CONSTRAINT fk_user_role_user FOREIGN KEY (user_id) REFERENCES users (user_id)
);

CREATE TABLE mission
(
    mission_id            BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    mission_name          VARCHAR(31)               NOT NULL,
    description           VARCHAR(511)              NOT NULL,
    goal                  VARCHAR(255),
    rule                  VARCHAR(255),
    image_url             VARCHAR(255),
    current_member_cnt    INT UNSIGEND              NOT NULL,
    visited_cnt           INT UNSIGEND              NOT NULL,
...
CREATE TABLE report
(
    report_id             BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    user_id               BIGINT UNSIGEND,
    reporter_id           BIGINT UNSIGEND,
    mission_id            BIGINT UNSIGEND,
...
(
    suspend_id            BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    started_datetime      DATE                      NOT NULL,
    ended_datetime        DATE                      NOT NULL,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    user_id               BIGINT UNSIGEND           NOT NULL,
    admin_id              BIGINT UNSIGEND           NOT NULL,
...
CREATE TABLE block
(
    block_id              BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    user_id               BIGINT UNSIGEND           NOT NULL,
    blocker_id            BIGINT UNSIGEND           NOT NULL,
...
(
    mission_member_id     BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    is_creator            BIT                       NOT NULL,
    status                VARCHAR(15)               NOT NULL,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    mission_id            BIGINT UNSIGEND           NOT NULL,
    user_id               BIGINT UNSIGEND,
...
(
    hashtag_id            BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
...
(
    mission_hashtag_id    BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    hashtag_id            BIGINT UNSIGEND           NOT NULL,
    mission_id            BIGINT UNSIGEND           NOT NULL,
...
CREATE TABLE feed
(
    feed_id               BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    liked_cnt             INT UNSIGEND              NOT NULL,
    image_url             VARCHAR(255),
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    mission_id            BIGINT UNSIGEND           NOT NULL,
    mission_member_id     BIGINT UNSIGEND           NOT NULL,
...
(
    feed_comment_id       BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    comment               VARCHAR(255),
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    feed_id               BIGINT UNSIGEND           NOT NULL,
    mission_member_id     BIGINT UNSIGEND           NOT NULL,
...
(
    feed_like_id          BIGINT UNSIGEND AUTO_INCREMENT PRIMARY KEY,
    created_date_time     DATETIME(6)               NOT NULL,
    updated_date_time     DATETIME(6)               NOT NULL,
    is_deleted            BIT                       NOT NULL,
    feed_id               BIGINT UNSIGEND           NOT NULL,
